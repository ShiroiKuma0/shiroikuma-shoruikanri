/*
 * 白い熊 fork (skui): the jobs the automation data door has started, and the
 * flag each of them watches to stop. Copied from 自由作業盤's
 * core/automation/AutomationJobs.kt (contract v2, §2a).
 */
